...
>
> - **[ffmpeg](https://ffmpeg.org/ffmpeg.html)** is required by `VideoVideoConverter`, `VideoDetectionService` and `VideoThumbService`.
> - **[ffprobe](https://ffmpeg.org/ffprobe.html)** is required by `VideoVideoQuery`.
>  
